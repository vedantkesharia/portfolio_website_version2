...
const researchPapers = [
  ...
  },
  {
    ...
    journal:
      "International Conference on Communication, Computing, and Data Security (ICCCDS 2025)",
    status: "Presented",
    year: "2025",
    description:
      "Built an NLP-based system to compare research papers, extract key entities, predict citation impact with LSTM, and rank relevance by abstract similarity.",
    tech: ["NLP", "TF-IDF", "LSTM", "Doc2Vec"],
  },
  {
    title:
      "Enhanced Nighttime Crime Surveillance Using Federated Learning: A Technical Evaluation of Aggregation Methods",
    journal:
                ...
                <span
                  className={`px-3 py-1 rounded-full text-xs ${
                    paper.status === "Published"
                      ...
                      ? "bg-green-900/50 text-green-300 border border-green-800"
                      : paper.status === "Copyright Granted"
                      ? "bg-green-900/50 text-green-300 border border-green-800"
